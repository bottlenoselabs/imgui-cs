// <auto-generated>
//  This code was generated by the following tool on 2023-05-22 02:39:38 GMT+00:00:
//      https://github.com/bottlenoselabs/c2cs (v5.3.3.0)
//
...
public static unsafe partial class PInvoke
{
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial byte* ImFontAtlasGetGlyphRangesGreek(ImFontAtlas* self);
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 24616, Pack = 8)]
        ...
        public readonly Span<CString> LocalizationTable
        {
            get
            {
                fixed (ImGuiContext* @this = &this)
                {
                    ...
                    var span = new Span<CString>(pointer, 8);
                    return span;
                }
            }
        }

        [FieldOffset(24144)] // size = 1
        public CBool LogEnabled;

        [FieldOffset(24148)] // size = 4
        public ImGuiLogType LogType;

        [FieldOffset(24152)] // size = 8
        public ImFileHandle LogFile;

        [FieldOffset(24160)] // size = 16
        public ImGuiTextBuffer LogBuffer;

        [FieldOffset(24176)] // size = 8
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 14336, Pack = 8)]
    public struct ImGuiIO
    {
        ...
        [FieldOffset(118)] // size = 1
        public CBool ConfigViewportsNoDecoration;

        [FieldOffset(119)] // size = 1
        ...
        [FieldOffset(216)] // size = 1
        public CBool WantCaptureMouse;

        [FieldOffset(217)] // size = 1
        public CBool WantCaptureKeyboard;

        [FieldOffset(218)] // size = 1
        public CBool WantTextInput;

        [FieldOffset(219)] // size = 1
        ...
        [FieldOffset(256)] // size = 2608
        public fixed byte _KeyMap[2608]; // int[652]
        ...
        public readonly Span<int> KeyMap
        {
            get
            {
                fixed (ImGuiIO* @this = &this)
                {
                    ...
                    var span = new Span<int>(pointer, 652);
                    return span;
                }
            }
        }

        [FieldOffset(2864)] // size = 652
        public fixed byte _KeysDown[652]; // _Bool[652]
        ...
        public readonly Span<CBool> KeysDown
        {
            get
            {
                fixed (ImGuiIO* @this = &this)
                {
                    ...
                    var span = new Span<CBool>(pointer, 652);
                    return span;
                }
            }
        }

        [FieldOffset(3516)] // size = 64
        public fixed byte _NavInputs[64]; // float[16]
        ...
        public readonly Span<float> NavInputs
        {
            get
            {
                fixed (ImGuiIO* @this = &this)
                {
                    ...
                    var span = new Span<float>(pointer, 16);
                    return span;
                }
            }
        }
        ...
        [FieldOffset(3608)] // size = 4
        public float MouseWheel;

        [FieldOffset(3612)] // size = 4
        public float MouseWheelH;

        [FieldOffset(3616)] // size = 4
        public ImGuiMouseSource MouseSource;

        [FieldOffset(3620)] // size = 4
        public ImGuiID MouseHoveredViewport;

        [FieldOffset(3624)] // size = 1
        public CBool KeyCtrl;

        [FieldOffset(3625)] // size = 1
        public CBool KeyShift;

        [FieldOffset(3626)] // size = 1
        public CBool KeyAlt;

        [FieldOffset(3627)] // size = 1
        public CBool KeySuper;

        [FieldOffset(3628)] // size = 4
        public ImGuiKeyChord KeyMods;

        [FieldOffset(3632)] // size = 10432
        public fixed byte _KeysData[10432]; // ImGuiKeyData[652]
        ...
        public readonly Span<ImGuiKeyData> KeysData
        {
            get
            {
                fixed (ImGuiIO* @this = &this)
                {
                    ...
                    var span = new Span<ImGuiKeyData>(pointer, 652);
                    return span;
                }
            }
        }

        [FieldOffset(14064)] // size = 1
        public CBool WantCaptureMouseUnlessPopupClose;

        [FieldOffset(14068)] // size = 8
        public Vector2 MousePosPrev;

        [FieldOffset(14076)] // size = 40
        ...
        [FieldOffset(14205)] // size = 1
        public CBool MouseWheelRequestAxisSwap;

        [FieldOffset(14208)] // size = 20
        ...
        [FieldOffset(14308)] // size = 4
        public float PenPressure;

        [FieldOffset(14312)] // size = 1
        public CBool AppFocusLost;

        [FieldOffset(14313)] // size = 1
        public CBool AppAcceptingEvents;

        [FieldOffset(14314)] // size = 1
        public sbyte BackendUsingLegacyKeyArrays;

        [FieldOffset(14315)] // size = 1
        public CBool BackendUsingLegacyNavInputArray;

        [FieldOffset(14316)] // size = 2
        public ushort InputQueueSurrogate;

        [FieldOffset(14320)] // size = 16
    ...
    public struct ImGuiKeyRoutingTable
    {
        ...
        public fixed byte _Index[280]; // ImGuiKeyRoutingIndex[140]
        ...
        public readonly Span<ImGuiKeyRoutingIndex> Index
        {
            get
            {
                fixed (ImGuiKeyRoutingTable* @this = &this)
                {
                    ...
                    var span = new Span<ImGuiKeyRoutingIndex>(pointer, 140);
                    return span;
                }
            }
        }

        [FieldOffset(280)] // size = 16
        public ImVectorImGuiKeyRoutingData Entries;

        [FieldOffset(296)] // size = 16
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 1100, Pack = 4)]
    public struct ImGuiStyle
    {
        ...
        [FieldOffset(209)] // size = 1
        public CBool AntiAliasedLinesUseTex;

        [FieldOffset(210)] // size = 1
    ...
    public struct ImGuiTable
    {
        ...
        [FieldOffset(248)] // size = 16
        public ImRect InnerRect;

        [FieldOffset(264)] // size = 16
        ...
        [FieldOffset(344)] // size = 16
        public ImRect HostClipRect;

        [FieldOffset(360)] // size = 16
    ...
    public struct ImGuiViewportP
    {
        ...
        [FieldOffset(168)] // size = 56
        public ImDrawData DrawDataP;

        [FieldOffset(224)] // size = 32
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 1120, Pack = 8)]
    public struct ImGuiWindow
    {
        ...
        [FieldOffset(232)] // size = 1
        public CBool ScrollbarX;

        [FieldOffset(233)] // size = 1
        public CBool ScrollbarY;

        [FieldOffset(234)] // size = 1
        public CBool ViewportOwned;

        [FieldOffset(235)] // size = 1
        public CBool Active;

        [FieldOffset(236)] // size = 1
        public CBool WasActive;

        [FieldOffset(237)] // size = 1
        public CBool WriteAccessed;

        [FieldOffset(238)] // size = 1
        public CBool Collapsed;

        [FieldOffset(239)] // size = 1
        ...
        [FieldOffset(266)] // size = 1
        public sbyte AutoFitChildAxises;

        [FieldOffset(267)] // size = 1
        ...
        [FieldOffset(576)] // size = 16
        public ImRect InnerClipRect;

        [FieldOffset(592)] // size = 16
        public ImRect WorkRect;

        [FieldOffset(608)] // size = 16
        public ImRect ParentWorkRect;

        [FieldOffset(624)] // size = 16
        public ImRect ClipRect;

        [FieldOffset(640)] // size = 16
        public ImRect ContentRegionRect;

        [FieldOffset(656)] // size = 4
        public ImVec2ih HitTestHoleSize;

        [FieldOffset(660)] // size = 4
        ...
        [FieldOffset(1052)] // size = 1
        public CBool MemoryCompacted;

        [FieldOffset(1053)] // size = 1
        ...
        [FieldOffset(1054)] // size = 2
        public short DockOrder;

        [FieldOffset(1056)] // size = 24
        public ImGuiWindowDockStyle DockStyle;

        [FieldOffset(1080)] // size = 8
    ...
    public static unsafe partial class ImGui
    {
        ...
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial CBool BeginTabBarEx(ImGuiTabBar* tabBar, ImRect bb, ImGuiTabBarFlags flags, ImGuiDockNode* dockNode);
        ...
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial void FocusTopMostWindowUnderOne(ImGuiWindow* underThisWindow, ImGuiWindow* ignoreWindow, ImGuiViewport* filterViewport);
        ...
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial ulong ImBitArrayGetStorageSizeInBytes(int bitcount);
        ...
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial ImGuiID ImHashData(void* data, ulong dataSize, ImGuiID seed);

        [CNode(Kind = "Function")]
        [LibraryImport(LibraryName, EntryPoint = "igImHashStr")]
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial ImGuiID ImHashStr(CString data, ulong dataSize, ImGuiID seed);
        ...
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial CBool ImageButton(CString strId, ImTextureID userTextureId, Vector2 size, Vector2 uv0, Vector2 uv1, Vector4 bgCol, Vector4 tintCol);

        [CNode(Kind = "Function")]
        [LibraryImport(LibraryName, EntryPoint = "igImageButtonEx")]
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial CBool ImageButtonEx(ImGuiID id, ImTextureID textureId, Vector2 size, Vector2 uv0, Vector2 uv1, Vector4 bgCol, Vector4 tintCol, ImGuiButtonFlags flags);
        ...
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial void StartMouseMovingWindowOrNode(ImGuiWindow* window, ImGuiDockNode* node, CBool undockFloatingNode);
