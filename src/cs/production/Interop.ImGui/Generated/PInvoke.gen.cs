...
// <auto-generated>
//  This code was generated by the following tool on 2023-08-06 18:13:04 GMT+00:00:
...
public static unsafe partial class PInvoke
{
    ...
    [CNode(Kind = "Function")]
    [LibraryImport(LibraryName, EntryPoint = "ImGuiListClipper_IncludeRangeByIndices")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void ImGuiListClipperIncludeRangeByIndices(ImGuiListClipper* self, int itemBegin, int itemEnd);
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 24712, Pack = 8)]
    public struct ImGuiContext
    {
        ...
        [FieldOffset(16376)] // size = 16
        public ImGuiStorage WindowsById;

        [FieldOffset(16392)] // size = 4
        public int WindowsActiveCount;

        [FieldOffset(16396)] // size = 8
        ...
        public readonly Span<CString> LocalizationTable
        {
            get
            {
                fixed (ImGuiContext* @this = &this)
                {
                    ...
                    var span = new Span<CString>(pointer, 9);
                    return span;
                }
            }
        }

        [FieldOffset(24240)] // size = 1
        public CBool LogEnabled;

        [FieldOffset(24244)] // size = 4
        public ImGuiLogType LogType;

        [FieldOffset(24248)] // size = 8
        public ImFileHandle LogFile;

        [FieldOffset(24256)] // size = 16
        public ImGuiTextBuffer LogBuffer;

        [FieldOffset(24272)] // size = 8
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 14328, Pack = 8)]
    public struct ImGuiIO
    {
        ...
        [FieldOffset(3600)] // size = 4
        public float MouseWheel;

        [FieldOffset(3604)] // size = 4
        ...
        [FieldOffset(3616)] // size = 1
        public CBool KeyCtrl;

        [FieldOffset(3617)] // size = 1
        public CBool KeyShift;

        [FieldOffset(3618)] // size = 1
        public CBool KeyAlt;

        [FieldOffset(3619)] // size = 1
        public CBool KeySuper;

        [FieldOffset(3620)] // size = 4
        public ImGuiKeyChord KeyMods;

        [FieldOffset(3624)] // size = 10432
        ...
        [FieldOffset(14056)] // size = 1
        public CBool WantCaptureMouseUnlessPopupClose;

        [FieldOffset(14060)] // size = 8
        public Vector2 MousePosPrev;

        [FieldOffset(14068)] // size = 40
        ...
        [FieldOffset(14197)] // size = 1
        public CBool MouseWheelRequestAxisSwap;

        [FieldOffset(14200)] // size = 20
        ...
        [FieldOffset(14300)] // size = 4
        public float PenPressure;

        [FieldOffset(14304)] // size = 1
        public CBool AppFocusLost;

        [FieldOffset(14305)] // size = 1
        public CBool AppAcceptingEvents;

        [FieldOffset(14306)] // size = 1
        public sbyte BackendUsingLegacyKeyArrays;

        [FieldOffset(14307)] // size = 1
        public CBool BackendUsingLegacyNavInputArray;

        [FieldOffset(14308)] // size = 2
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 1124, Pack = 4)]
    public struct ImGuiStyle
    {
        ...
        [FieldOffset(1104)] // size = 4
        public float HoverStationaryDelay;

        [FieldOffset(1108)] // size = 4
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 1136, Pack = 8)]
    public struct ImGuiWindow
    {
        ...
        [FieldOffset(1068)] // size = 1
        public CBool MemoryCompacted;

        [FieldOffset(1069)] // size = 1
        ...
        [FieldOffset(1070)] // size = 2
        public short DockOrder;

        [FieldOffset(1072)] // size = 24
        public ImGuiWindowDockStyle DockStyle;

        [FieldOffset(1096)] // size = 8
    ...
    public enum ImGuiItemFlags : int
    {
        ...
        ImGuiItemflagsAllowOverlap = 512,
        Inputable = 1024
    }
